// v49: tournament reset + all-player bet confirmation gate + iPhone smooth audio race, no whip
'use strict';
...
document.addEventListener('pointerdown',()=>{unlockAudio();primeMediaAudio()}, {capture:true,passive:true});
